...
par(mar=c(4,0,0,0), oma=c(1,0,0,0))
...
plot(h,freq=F,labels=labs,ylim=c(0,1.08*max(h$density)),xlab=colnames(mydata),ylab="(porcentaje)",col="#51C6D9",border="#00517A",cex=4)
